 ...
 * @brief ROS 2 Client Node that requests the addition of two integers from a service.
 * 
 ...
 * @brief A client node that requests the addition of two integers from the service.
 */
class AddTwoIntsClient : public rclcpp::Node {
 public:
   ...
   */
  AddTwoIntsClient(int64_t a, int64_t b) : Node("add_two_ints_client"), a_(a), b_(b) {
